      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                {[
                    { icon: ShieldCheck, title: "Безопасная сделка", desc: "Официальный договор, чеки для командировочных, полная прозрачность." },
                    { icon: CheckCircle2, title: "Идеальная чистота", desc: "Профессиональный клининг после каждого гостя, белоснежное белье." },
                    { icon: Key, title: "Бесконтактный заезд", desc: "Заселяйтесь в удобное время 24/7 без ожидания и лишних встреч." }
                ].map((item, idx) => (
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex justify-between items-end mb-16">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-4 tracking-tight">Наши объекты</h2>
              <p className="text-slate-500 text-lg">Только проверенные квартиры под личным управлением</p>
            </div>
