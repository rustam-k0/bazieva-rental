          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-slate-500 mb-10 leading-relaxed font-light">
                Меня зовут Мадина Базиева. Я строю сервис, где традиционное гостеприимство работает по строгим правилам отелей. Лично гарантирую чистоту, честность и отсутствие бытовых сюрпризов.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                {[
                    { 
                      ...
                      desc: "Работаю официально. Предоставляю полный пакет отчетных документов для командировок и прозрачный договор." 
                    },
                    { 
                      icon: CheckCircle2, 
                      title: "Маниакальная чистота", 
                      desc: "Мои горничные работают по чек-листам 4* отелей. Свежее белье из прачечной и дезинфекция — стандарт, а не опция." 
                    },
                    { 
                      icon: Key, 
                      title: "Умный доступ 24/7", 
                      desc: "Ценим ваше время. Дистанционное заселение без ожиданий, лишних встреч и передачи ключей из рук в руки." 
                    }
                ].map((item, idx) => (
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex justify-between items-end mb-16">
            <div>
              ...
              <p className="text-slate-500 text-lg">Квартиры, которые я рекомендую лично</p>
            </div>
